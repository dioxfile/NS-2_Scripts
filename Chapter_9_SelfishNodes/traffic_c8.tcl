...
#
#
# 2 connecting to 8 at time 8.0978678042524805
#
...
#
# 10 connecting to 14 at time 8.0951477136905989
#
set udp_(1) [new Agent/UDP]
$ns_ attach-agent $node_(10) $udp_(1)
set null_(1) [new Agent/Null]
$ns_ attach-agent $node_(14) $null_(1)
...
#
# 24 connecting to 25 at time 8.0381870033862945
#
set udp_(2) [new Agent/UDP]
$ns_ attach-agent $node_(24) $udp_(2)
set null_(2) [new Agent/Null]
$ns_ attach-agent $node_(25) $null_(2)
...
#
# 36 connecting to 37 at time 8.0356390442399483
#
set udp_(3) [new Agent/UDP]
$ns_ attach-agent $node_(36) $udp_(3)
set null_(3) [new Agent/Null]
$ns_ attach-agent $node_(37) $null_(3)
...
#
# 42 connecting to 43 at time 8.0643638100309118
#
set udp_(5) [new Agent/UDP]
$ns_ attach-agent $node_(42) $udp_(5)
set null_(5) [new Agent/Null]
$ns_ attach-agent $node_(43) $null_(5)
...
#
# 4 connecting to 5 at time 8.0646923901814471
#
